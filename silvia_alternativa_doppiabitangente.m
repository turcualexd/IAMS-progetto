...
rc = 20000; % dev'essere uguale a rat e raggio della circolare su cui ci inseriamo
...
%% bitangente da circolare a finale

[DeltaV4, DeltaV5, deltaT4, om_f_new, omt2, at2, et2] = bitangentTransfer(rc, e_2, af, ef, 'pa', omf);

% arco bitangente
plotOrbit(at2, et2, i_f, OMf, omt2, pi, 2*pi, 0.001, 'rad', 'r')

[rrpt, vvpt] = par2car(at2, et2, i_f, OMf, omt2, pi, "rad");
plot3(rrpt(1), rrpt(2), rrpt(3), 'k*');
[rrat, vvat] = par2car(at2, et2, i_f, OMf, omt2, 2*pi, "rad");
plot3(rrat(1), rrat(2), rrat(3), 'k*');
