clear, clc, close all;
load("alex_deltaV_minimo_workspace.mat")

Terra_3D

% Orbita iniziale
plotOrbit(ai, ei, i_i, OMi, omi, thi, th1_iniziale, 0.001, 'rad', 'r');
plotOrbit_leggero(ai, ei, i_i, OMi, omi, th1_iniziale, thi, 0.001, 'rad', 'r--');
