...
%% 3: arrivo a apocentro

deltat2 = TOF(ai, ei, theta_cp, pi);

%% 4: bitangentTransfer PA

[DeltaV2, DeltaV3, deltat3, om_f_new, om_t, at, et] = bitangentTransfer(ai, ei, af, ef, 'ap', om2);
...
% cambio piano
plotOrbit(ai, ei, i_f, OMf, om2, theta_cp, pi, 0.001, 'rad', 'm'); 

% arco bitangente
plotOrbit(at, et, i_f, OMf, om_t, pi, 2*pi, 0.001, 'rad', 'c');

% cambio anomalia pericentro
plotOrbit(af, ef, i_f, OMf, om2, 0, theta_cwi, 0.001, 'rad', 'g'); 
