...
%% bitangente AP fino a distanza apocentro finale, circolarizzazione


[DeltaV1, DeltaV2, deltaT2, om_f_new, omt, at, et] = bitangentTransfer(ai, ei, af, ef, 'ap', omi);

% arco bitangente
plotOrbit(at, et, ii, OMi, omt, pi, 2*pi, 0.001, 'rad', 'b')

[rrpt, vvpt] = par2car(at, et, ii, OMi, omt, pi, "rad");
plot3(rrpt(1), rrpt(2), rrpt(3), 'k*');
[rrat, vvat] = par2car(at, et, ii, OMi, omt, 2*pi, "rad");
plot3(rrat(1), rrat(2), rrat(3), 'k*');

plotOrbit(af, ef, ii, OMi, omt, 0, 2*pi, 0.001, 'rad', 'k')
...
% iniziale
Terra_3D
plotOrbit(ai, ei, ii, OMi, omi, thi, pi, 0.001, 'rad', 'r')
hold on
plot3(rr(1), rr(2), rr(3), 'ko');
...
plotOrbit(af, ef, ii, OMi, omt, 0, theta_cp, 0.001, 'rad', 'k')

% cambio piano
plotOrbit(af, ef, i_f, OMf, om2, theta_cp, 2*pi, 0.001, 'rad', 'm')
plotOrbit(af, ef, i_f, OMf, om2, 0, theta_cwi, 0.001, 'rad', 'm')
[rrcp, vvcp] = par2car(af, ef, i_f, OMf, om2, theta_cp, "rad");
plot3(rrcp(1), rrcp(2), rrcp(3), 'k*');
%
