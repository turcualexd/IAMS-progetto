...
deltat3 = TOF(ai, ei, theta_cwf, pi);

%% 6: bitangentTransfer

[DeltaV3, DeltaV4, deltat4, om_f_new, om_t, at, et] = bitangentTransfer(ai, ei, af, ef, 'ap', omf);


%% 7: attesa fino a theta finale
deltat5 = TOF(af, ef, 0, thf);
...
plotOrbit(ai, ei, i_f, OMf, omf, theta_cwf, pi, 0.001, 'rad', 'c');

% arco bitangente
plotOrbit(at, et, i_f, OMf, om_t, pi, 2*pi, 0.001, 'rad', 'g'); 
